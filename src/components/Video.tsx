            ...
            <div className="p-8 max-w-[1100px] mx-auto">
                <div className="block md:flex items-start gap-16">
                    ...
                    <div className="flex flex-col gap-4">
                        <a href="#" className="mt-6 md:mt-0 p-4 text-sm bg-green-500 flex items-center rounded font-bold uppercase gap-2 justify-center hover:bg-green-700 transition-colors">
                            <DiscordLogo size={24}/>
                ...
                <div className="flex flex-col gap-8 mt-20 md:grid md:grid-cols-2">
                    <a href="#" className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors">
                        ...
                        <div className="md:h-full p-6 flex items-center">
                            <CaretRight size={24} />
                        </div>
                    </a>
